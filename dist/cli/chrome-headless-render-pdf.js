...
var argv = require('minimist')(process.argv.slice(2), {
    string: ['url', 'pdf', 'chrome-binary', 'chrome-option', 'remote-host', 'remote-port', 'window-size', 'paper-width', 'paper-height', 'page-ranges', 'scale', 'header-template', 'footer-template'],
    boolean: ['no-margins', 'include-background', 'landscape', 'display-header-footer']
});
...
var displayHeaderFooter = void 0;
